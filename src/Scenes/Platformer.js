class Platformer extends Phaser.Scene {
    ...
    create() {
        ...
        //EC1
        //Find jewel and add createFromObjects
        this.jewels = this.map.createFromObjects("Objects", {
            name: "jewel",
            key: "tilemap_sheet",
            frame: 67
        });
    ...
    update() {
        if(cursors.left.isDown) {
            ...
            my.vfx.walking.setParticleSpeed(this.PARTICLE_VELOCITY*-1, 0);
